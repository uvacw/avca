...
def run_clarifai_classifier(clarifai_api_key, path_save, path_source, image_list):
    ...
    print('Total images in list provided:', len(image_list))
    print('images found in path_source:', len(filenames)) 
